...
6 bis. Nouvelle requete, meme chose avec `supabase/migration-02.sql` : cela ajoute le prix libre et les reglages de marque.
...
**Un evenement a prix libre**
Coche "Prix libre" : le site affiche une pastille violette Prix libre et le bouton devient "je participe au prix libre". Tu peux quand meme remplir le champ tarifs pour indiquer un montant conseille, il s affiche en petit sous la mention.

**Le logo et la banderole**
Reglages > Logo du site pour remplacer le logo de l entete et du pied de page, et Banderole defilante pour changer la phrase qui defile, dans les trois langues.
