        ...
        <aside className="h-max rounded-2xl border border-white/12 bg-ink-soft p-6 md:sticky md:top-28">
          <dl className="space-y-5">
            ...
            <div>
              ...
              <dd className="mt-1 font-display text-2xl text-acid">
                {event.is_free ? dict.programme.free : event.price_label}
              </dd>
            </div>
          </dl>
          ...
          <div className="mt-7">
            {event.is_free ? (
              <p className="rounded-full border border-acid/40 px-5 py-3 text-center font-mono text-[11px] uppercase tracking-[0.14em] text-acid">
                {dict.event.ctaFree}
              </p>
            ) : event.ticket_url ? (
              ...
              <p className="rounded-full border border-white/20 px-5 py-3 text-center font-mono text-[11px] uppercase tracking-[0.14em] text-smoke">
                {dict.event.ctaSoon}
              </p>
            )}
          </div>
