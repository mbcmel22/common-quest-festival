  ...
  return (
    <article className="shell max-w-3xl py-16 md:py-24">
      ...
      <p className="mt-4 font-mono text-[11px] uppercase tracking-[0.14em] text-smoke">
        Conforme au RGPD, reglement UE 2016/679, et à la loi Informatique et Libertés
      </p>
      ...
      <div className="mt-10 space-y-8 text-paper/80">
        ...
        <section>
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5">
            <li>Création de compte : adresse email, prénom et nom si vous les renseignez, langue choisie.</li>
            <li>Mot de passe : stocke uniquement sous forme chiffrée et irréversible par notre prestataire d'authentification. Personne dans l’équipe, y compris les administrateurs, ne peut le lire.</li>
        ...
        <section>
          ...
          <p className="mt-3">
            ...
            sa fermeture. Les emails de newsletter sont conservés jusqu'au désabonnement. La base légale est le
        ...
        <section>
          ...
          <p className="mt-3">
            ...
            portabilite. Écrivez à associationprism.hello@gmail.com : nous repondons sous un mois. Vous pouvez aussi
        ...
        <section>
          ...
          <p className="mt-3">
            Vercel pour l'hebergement du site et Supabase pour la base de données et l'authentification, avec un
            stockage en Union européenne. Les billetteries sont opérées par des services tiers avec leurs propres
