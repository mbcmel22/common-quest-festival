...
export const EDITABLE_COPY: { path: string; label: string; multiline?: boolean }[] = [
  ...
  { path: "home.askipCta", label: "Accueil, bouton Askip" },
  ...
  { path: "infos.volunteerTitle", label: "Infos, titre bénévolat" },
  { path: "infos.volunteerText", label: "Infos, texte bénévolat", multiline: true },
  { path: "infos.volunteerCta", label: "Infos, bouton bénévolat" },
  { path: "infos.imageTitle", label: "Infos, titre droit à l’image" },
  { path: "infos.imageText", label: "Infos, texte droit à l’image", multiline: true },
